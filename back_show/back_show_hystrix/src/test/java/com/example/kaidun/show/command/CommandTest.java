...
public class CommandTest {
    ...
    public void execute() {
        ...
        //同步执行command
        String result = commandDemo.execute().toString();
    ...
    public void observeTest() {
        ...
        observe.subscribe(new Subscriber<String>() {
            ...
            public void onNext(String result) {
                ...
                System.err.println("observe , onNext - result = " + result + ",speeding = " + (endTime1 - beginTime));
            }
        });
    ...
    public void toObserveTest() throws InterruptedException {
        ...
        long endTime = System.currentTimeMillis();
        System.out.println("result1 : " + result + " , speeding = " + (endTime - beginTime));
    ...
    public void requestCache() {
        ...
        long beginTime = System.currentTimeMillis();
        CommandDemo c0 = new CommandDemo("execute0");
        CommandDemo c1 = new CommandDemo("execute1");
        CommandDemo c2 = new CommandDemo("execute2");
        CommandDemo c3 = new CommandDemo("execute0");
        //同步执行command
        String r0 = c0.execute().toString();
        long endTime = System.currentTimeMillis();
        System.out.println("result : " + r0 + " , speeding = " + (endTime - beginTime));

        //第二次请求
        String r1 = c1.execute().toString();
        System.out.println("result : " + r1 + " , speeding = " + (System.currentTimeMillis() - beginTime));

        //第三次请求
        String r2 = c2.execute().toString();
        System.out.println("result : " + r2 + " , speeding = " + (System.currentTimeMillis() - beginTime));

        //第四次请求
        String r3 = c3.execute().toString();
...
//熔断演示
    ...
    public void CBTest() throws InterruptedException {
        //正确-业务
        CommandDemo c1 = new CommandDemo("true-1");
        System.out.println(c1.execute());

        //错误 - 业务
        CommandDemo c2 = new CommandDemo("error-2");
        System.out.println(c2.execute());


        Thread.sleep(1000l);
        //正确-业务
        CommandDemo c3 = new CommandDemo("true-3");
...
//        CommandDemo c4 = new CommandDemo("error-4");
//        System.out.println(c4.execute());
                 //成功
        CommandDemo c5 = new CommandDemo("true-5");
